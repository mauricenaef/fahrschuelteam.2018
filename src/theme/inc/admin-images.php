...
function thumbnail_gallery( $data, $size = NULL ) {
	if($data) {

		echo '<div class="thumbnail-gallery gallery align-middle '. $size . '">';

		foreach($data as $image_id) {

			$image_url = wp_get_attachment_image_url( $image_id, 'full' );

			echo '<a href="' . $image_url . '" class="single-image item shadow-small">';
